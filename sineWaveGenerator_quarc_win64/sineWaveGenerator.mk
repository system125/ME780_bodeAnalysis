###########################################################################
## Makefile generated for component 'sineWaveGenerator'. 
## 
## Makefile     : sineWaveGenerator.mk
## Generated on : Wed Dec 13 04:18:52 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\sineWaveGenerator.rt-win64
...
START_DIR                 = C:\Users\ssapkota\Downloads\Project_2_PrecisionControls\Project_2_PrecisionControls\Question2_machine2
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = sineWaveGenerator_comp.rsp
CMD_FILE                  = sineWaveGenerator.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\sineWaveGenerator.rt-win64
...
DEFINES_STANDARD = -DMODEL=sineWaveGenerator -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\sineWaveGenerator_quarc_win64\rtGetInf.c $(START_DIR)\sineWaveGenerator_quarc_win64\rtGetNaN.c $(START_DIR)\sineWaveGenerator_quarc_win64\rt_nonfinite.c $(START_DIR)\sineWaveGenerator_quarc_win64\sineWaveGenerator.c $(START_DIR)\sineWaveGenerator_quarc_win64\sineWaveGenerator_data.c $(START_DIR)\sineWaveGenerator_quarc_win64\sineWaveGenerator_main.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj sineWaveGenerator.obj sineWaveGenerator_data.obj sineWaveGenerator_main.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\sineWaveGenerator_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\sineWaveGenerator_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : $(START_DIR)\sineWaveGenerator_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sineWaveGenerator_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\sineWaveGenerator_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sineWaveGenerator_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\sineWaveGenerator_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sineWaveGenerator_quarc_win64\rt_nonfinite.c


sineWaveGenerator.obj : $(START_DIR)\sineWaveGenerator_quarc_win64\sineWaveGenerator.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sineWaveGenerator_quarc_win64\sineWaveGenerator.c


sineWaveGenerator_data.obj : $(START_DIR)\sineWaveGenerator_quarc_win64\sineWaveGenerator_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sineWaveGenerator_quarc_win64\sineWaveGenerator_data.c


sineWaveGenerator_main.obj : $(START_DIR)\sineWaveGenerator_quarc_win64\sineWaveGenerator_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sineWaveGenerator_quarc_win64\sineWaveGenerator_main.c
