...
#ifndef RTW_HEADER_sineWaveGenerator_h_
#define RTW_HEADER_sineWaveGenerator_h_
#include <math.h>
#include <string.h>
#ifndef sineWaveGenerator_COMMON_INCLUDES_
#define sineWaveGenerator_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* sineWaveGenerator_COMMON_INCLUDES_ */

#include "sineWaveGenerator_types.h"
...
#define sineWaveGenerator_rtModel      RT_MODEL_sineWaveGenerator_T
...
typedef struct {
  ...
  void *HILReadEncoder2_PWORK;         /* '<S1>/HIL Read Encoder 2' */
  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  ...
  int32_T HILReadEncoder2_Buffer;      /* '<S1>/HIL Read Encoder 2' */
  struct {
    int_T PrevIndex;
...
} DW_sineWaveGenerator_T;

/* Backward compatible GRT Identifiers */
#define rtB                            sineWaveGenerator_B
#define BlockIO                        B_sineWaveGenerator_T
#define rtP                            sineWaveGenerator_P
#define Parameters                     P_sineWaveGenerator_T
#define rtDWork                        sineWaveGenerator_DW
#define D_Work                         DW_sineWaveGenerator_T

/* Parameters (default storage) */
struct P_sineWaveGenerator_T_ {
  uint32_T HILReadEncoder1_channels; /* Mask Parameter: HILReadEncoder1_channels
                                      * Referenced by: '<S1>/HIL Read Encoder1'
                                      */
  uint32_T HILReadEncoder2_channels; /* Mask Parameter: HILReadEncoder2_channels
  ...
  boolean_T HILReadEncoder1_Active;/* Computed Parameter: HILReadEncoder1_Active
                                    * Referenced by: '<S1>/HIL Read Encoder1'
                                    */
  boolean_T HILReadEncoder2_Active;/* Computed Parameter: HILReadEncoder2_Active
                                    * Referenced by: '<S1>/HIL Read Encoder 2'
                                    */
...
struct tag_RTM_sineWaveGenerator_T {
  const char_T *path;
...
extern P_sineWaveGenerator_T sineWaveGenerator_P;

/* Block signals (default storage) */
extern B_sineWaveGenerator_T sineWaveGenerator_B;

/* Block states (default storage) */
extern DW_sineWaveGenerator_T sineWaveGenerator_DW;

/* Model entry point functions */
extern void sineWaveGenerator_initialize(void);
extern void sineWaveGenerator_output(void);
extern void sineWaveGenerator_update(void);
extern void sineWaveGenerator_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern sineWaveGenerator_rtModel *sineWaveGenerator(void);
...
extern RT_MODEL_sineWaveGenerator_T *const sineWaveGenerator_M;
 ...
 *
 * '<Root>' : 'sineWaveGenerator'
 * '<S1>'   : 'sineWaveGenerator/Plant'
 */
#endif                                 /* RTW_HEADER_sineWaveGenerator_h_ */
